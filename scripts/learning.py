...
"""
def analysis(figurenum, train_y, train_X, test_y, test_X, plot, problem_name):
...
def main():
  ...
  with open(FLAGS.inputfile, "r") as infile:
    ...
    figurenum = 0
    figurenum = analysis(figurenum, y1, X1, y2, X2, FLAGS.plot, FLAGS.problem_name)
    figurenum = analysis(figurenum, y2, X2, y1, X1, FLAGS.plot, FLAGS.problem_name)
