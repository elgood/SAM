...
private:
  ...
  uint64_t hwm;  ///> The high water mark

  size_t feedCount = 0; ///> How many items this node has seen through feed()
  size_t metricInterval = 10000; ///> How many seen before spitting metrics out
