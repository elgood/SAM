...
#ifndef PROTOBUF_INCLUDED_NetflowEdgeRequest_2eproto
#define PROTOBUF_INCLUDED_NetflowEdgeRequest_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_NetflowEdgeRequest_2eproto 
...
namespace google {
namespace protobuf {
template<> ::sam::NetflowEdgeRequest* Arena::CreateMaybeMessage<::sam::NetflowEdgeRequest>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace sam {
...
class NetflowEdgeRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sam.NetflowEdgeRequest) */ {
 public:
  ...
  inline NetflowEdgeRequest* New() const final {
    return CreateMaybeMessage<NetflowEdgeRequest>(NULL);
  }

  NetflowEdgeRequest* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<NetflowEdgeRequest>(arena);
  }
...
#endif  // PROTOBUF_INCLUDED_NetflowEdgeRequest_2eproto
