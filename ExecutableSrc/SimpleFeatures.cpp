            ...
            std::string printerLocation)
{
  ...
  producer->registerConsumer(averageSrcTotalBytes);
  if (subscriber != NULL) {
  ...
  auto varDestTotalBytes = std::make_shared<
                      ExponentialHistogramVariance<double, EdgeType,
                                                 ...
                                                 DestIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(varDestTotalBytes);
  if (subscriber != NULL) {
  ...
  auto averageDuration = std::make_shared<
                      ExponentialHistogramAve<double, EdgeType,
                                                 ...
                                                 DestIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(averageDuration);
  if (subscriber != NULL) {
  ...
  auto varDuration = std::make_shared<
                      ExponentialHistogramVariance<double, EdgeType,
                                                 ...
                                                 DestIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(varDuration);
  if (subscriber != NULL) {
  ...
  auto varSrcPayloadBytes = std::make_shared<
                      ExponentialHistogramVariance<double, EdgeType,
                                                 ...
                                                 DestIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(varSrcPayloadBytes);
  if (subscriber != NULL) {
  ...
  auto varSrcPacketCount = std::make_shared<
                      ExponentialHistogramVariance<double, EdgeType,
                                                 ...
                                                 DestIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(varSrcPacketCount);
  if (subscriber != NULL) {
  ...
  auto averageSrcTotalBytesSourceIp = std::make_shared<
                      ExponentialHistogramAve<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(averageSrcTotalBytesSourceIp);
  if (subscriber != NULL) {
  ...
  auto varSrcTotalBytesSourceIp = std::make_shared<
                      ExponentialHistogramVariance<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(varSrcTotalBytesSourceIp);
  if (subscriber != NULL) {
  ...
  auto averageDestTotalBytesSourceIp = std::make_shared<
                      ExponentialHistogramAve<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(averageDestTotalBytesSourceIp);
  if (subscriber != NULL) {
  ...
  auto varDestTotalBytesSourceIp = std::make_shared<
                      ExponentialHistogramVariance<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(varDestTotalBytesSourceIp);
  if (subscriber != NULL) {
  ...
  auto averageDurationSourceIp = std::make_shared<
                      ExponentialHistogramAve<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(averageDurationSourceIp);
  if (subscriber != NULL) {
  ...
  auto varDurationSourceIp = std::make_shared<
                      ExponentialHistogramVariance<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(varDurationSourceIp);
  if (subscriber != NULL) {
  ...
  auto averageSrcPayloadBytesSourceIp = std::make_shared<
                      ExponentialHistogramAve<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(averageSrcPayloadBytesSourceIp);
  if (subscriber != NULL) {
  ...
  auto varSrcPayloadBytesSourceIp = std::make_shared<
                      ExponentialHistogramVariance<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(varSrcPayloadBytesSourceIp);
  if (subscriber != NULL) {
  ...
  auto averageDestPayloadBytesSourceIp = std::make_shared<
                      ExponentialHistogramAve<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(averageDestPayloadBytesSourceIp);
  if (subscriber != NULL) {
  ...
  auto varDestPayloadBytesSourceIp = std::make_shared<
                      ExponentialHistogramVariance<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(varDestPayloadBytesSourceIp);
  if (subscriber != NULL) {
  ...
  auto averageSrcPacketCountSourceIp = std::make_shared<
                      ExponentialHistogramAve<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(averageSrcPacketCountSourceIp);
  if (subscriber != NULL) {
  ...
  auto varSrcPacketCountSourceIp = std::make_shared<
                      ExponentialHistogramVariance<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(varSrcPacketCountSourceIp);
  if (subscriber != NULL) {
  ...
  auto averageDestPacketCountSourceIp = std::make_shared<
                      ExponentialHistogramAve<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(averageDestPacketCountSourceIp);
  if (subscriber != NULL) {
  ...
  auto varDestPacketCountSourceIp = std::make_shared<
                      ExponentialHistogramVariance<double, EdgeType,
                                                 ...
                                                 SourceIp>>
                          (N, 2, nodeId, featureMap, identifier);
  producer->registerConsumer(varDestPacketCountSourceIp);
  if (subscriber != NULL) {
